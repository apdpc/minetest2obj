...
local jailpos = { x = -1, y = 50, z = -1 }

local players_in_jail = { };

minetest.register_chatcommand("jail", {
    params = "<player>",
    description = "Envoyer un joueur en prison",
	privs = {jail=true},
    func = function ( name, param )
        ...
        if (player) then
			...
			minetest.chat_send_player(param, "Vous etes envoye en prison")
			minetest.chat_send_all(""..param.." a ete envoye en prison par "..name.."")
        end
    end,
})


local releasepos = { x = 1, y = 1, z = 1 }
 
minetest.register_chatcommand("release", {
    params = "<player>",
    description = "Relacher un joueur de prison",
	privs = {jail=true},
    func = function ( name, param )
        ...
        if (player) then
			...
			minetest.chat_send_player(param, "Vous etes libere de prison")
			minetest.chat_send_all(""..param.." a ete libere de la prison par "..name.."")
        end
    end,
})
